...
local function KonstantDecompile(scriptPath: Script | ModuleScript | LocalScript): string
    return call("/konstant/decompile", scriptPath)
end

local function KonstantDisassemble(scriptPath: Script | ModuleScript | LocalScript): string
    return call("/konstant/disassemble", scriptPath)
end

getgenv().KonstantDecompile = KonstantDecompile
getgenv().KonstantDisassemble = KonstantDisassemble
